...
-->
I'm:
- currently building [Precogly](https://github.com/precogly/precogly) - an open-source threat modeling platform 
- the former developer of an open-source tool to help AI Governance teams in large healthcare systems 
...
- NextJS, React, Django, Streamlit, FastAPI, Web scraping(Playwright), PostgreSQL and other adjacent technologies
